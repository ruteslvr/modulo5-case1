...
function Vendedores() {
  ...
  return (
    <div className={styles.vendedores_container}>
      <h1>Depoimentos</h1>
      <p>Aqui você pode incluir, editar e deletar os depoimentos sobre a pousada.</p>
     
      <FormVend handleSubmit={createPost} btnText={"Inserir depoimento"} /> {/*Essa prop(btnText) irá mudar para de acordo com o método. Esse método será um POST. */}
    </div>
  );
